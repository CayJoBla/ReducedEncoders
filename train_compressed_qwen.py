...
def train(model_name=None, dataset_path=None, dataset_name=None, split="train", tokenizer=None, revision="main", train_size=None, 
          ...
          output_dir=None, push_to_hub=False, run_name=None, seed=None, disable_tqdm=False, verbose=False, trust_remote_code=False):
    ## Set seed
    if seed is not None:
        set_seed(seed)
