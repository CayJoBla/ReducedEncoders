# modeling_mistral_reduced.py

from transformers import MistralModel   # TODO: CHECK
...
class MistralReducedPreTrainedModel(ReducedPreTrainedModel):
    """An abstract class for defining defaults for reduced BERT models."""
    config_class = MistralReducedConfig
    base_model_prefix = "mistral"


class MistralCompressedForPretraining(MistralReducedPreTrainedModel):
    def __init__(
        self, 
        config=None,
        base_model=None,
        ...
        **kwargs
        ...
        # Construct the model
        self.mistral = base_model or MistralModel(self.config, **kwargs)
...
class MistralReducedModel(MistralReducedPreTrainedModel):
    def __init__(
        self, 
        config=None, 
        base_model=None, 
