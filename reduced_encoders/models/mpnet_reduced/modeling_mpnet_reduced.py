...
class MPNetCompressedModel(MPNetReducedPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, 
        ...
        if not return_dict:
            return (reduced_pooled, None, sequence_output, pooled_output, outputs.hidden_states, outputs.attentions)

        return ReducedModelOutputWithPooling(
            last_hidden_state=reduced_pooled,
            pooler_output=None,
...
class SBertMPNetReducedModel(MPNetReducedPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, 
        ...
        if not return_dict:
            return (sequence_output, pooled_output, sequence_output, pooled_output, outputs.hidden_states, outputs.attentions)
